...
const AdminTextEditor = ({
  ...
  useEffect(() => {
    ...
    if (debounceTextLink && regexLink.test(debounceTextLink)) {
      fetch(
        `https://impulsrent.ru:8203/api/notify/getTelegraphData?url=${debounceTextLink}`
      )
        .then((res) => res.json())
        .then((res) => {
          setMetaData(res);
    ...
    <>
      <div className={`${styles.container}`}>
        <TextField
          ...
          buttonClassName={
            formErrors.title_entered && styles.buttonTextFieldError
          }
        ...
        <TextField
          ...
          buttonClassName={
            formErrors.text_entered && styles.buttonTextFieldError
          }
        ...
        >
          ...
          <ArrowSVG
            className={`${styles.arrow} ${
              activeTextFields.link && styles.active
            }`}
            width={19}
            height={19}
          />
